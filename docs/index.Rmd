...
Calculating the study level covariances between the two outcomes. We only use the effect sizes that were calculated for Hyperactivity/impulsivity and Inattention. We use an estimated correlation between the two outcomes
